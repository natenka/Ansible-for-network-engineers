...
* синтаксис {{ inventory_hostname }} - это способ указания переменных. Если вы знакомы с Jinja2, этот формат должен быть вам знаком (почитать о Jinja2 можно [тут](https://natenka.gitbooks.io/pyneng/content/book/13_jinja2/)).
